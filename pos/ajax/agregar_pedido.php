...

{
	...
	?>
											<tr>
												<td class="visible-md visible-lg" ><?php echo htmlspecialchars($codigo_producto, ENT_QUOTES, 'UTF-8');?></td>
												<td><?php echo intval($cantidad);?></td>
												<td><?php echo htmlspecialchars($nombre_producto . $marca_producto, ENT_QUOTES, 'UTF-8');?></td>
